...
<div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-y-4 gap-x-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
    ...
    <div>
        <label for="other-filters" class="block text-sm font-medium leading-6 text-gray-900">Other Filters</label>
        <select id="other-filters" name="other-filters" class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
