...
<article {{ $attributes->merge(["class" => "flex flex-col items-start p-4 -m-4 transition hover:bg-gray-100 rounded-2xl"]) }}>
    ...
    <div class="max-w-xl h-full flex flex-col justify-between">
        <div>
